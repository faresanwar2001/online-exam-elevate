...
export default function LoginForm(){
  ...
  const loginSchema = z.object({
    ...
    password: z.string({required_error:"Password is required"}).min(1,{message:"password is less than one character"}),
  })
...
<form onSubmit={handleSubmit(handleSubmitForm)}  className="   flex flex-col gap-6  ">
   ...
   {errors.password ? <div className="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
    ...
    <p className="text-end"><Link href={"/components/auth/forgetPassword"} className="text-[#4461F2]">Forget Your Password ?</Link></p>
